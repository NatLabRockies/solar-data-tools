...
To report a bug, first make sure there isn't already an open [GitHub Issue](https://github.com/NatLabRockies/solar-data-tools/issues)
...
Look through the [GitHub Issues](https://github.com/NatLabRockies/solar-data-tools/issues) for any
...
2. Create your own fork of the Solar Data Tools [repository](https://github.com/NatLabRockies/solar-data-tools).
